    ...
    <footer class="page-footer">
      ...
      <div class="footer-nav">
        <div class="container clearfix">
          ...
          <div class="footer-nav__col footer-nav__col--contacts">
            ...
            Admin : Nur Amaliah Azzahra<br>
            Cirebon, Jawa Barat, Indonesia.
          </address>
            <div class="phone">
              Telephone:
              <a class="phone__number" href="tel:0123456789">0882-0004-89612</a>
            </div>
            <div class="email">
              Email:
              <a href="mailto:support@yourwebsite.com" class="email__addr">nuramalia3327@gmail.com</a>
            </div>
          </div>
      ...
      <div class="page-footer__subline">
        <div class="container clearfix">
          ...
          <div class="developer">
            Developed by Nur Amaliah
          </div>

          <div class="designby">
            Design by Nur Amaliah
          </div>
